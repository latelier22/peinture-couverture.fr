...
const Footer = () => {
  ...
  return (
    <footer className="bg-sky-600 text-center text-white dark:bg-neutral-600 dark:text-neutral-200">
      ...
      <div className="mx-6 pt-8 pb-4 text-center">
        <div className="mb-6">
          ...
          <p className="mb-4 text-white">Intervention 7j/7 !</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mb-4">
          ...
          <div className="mb-6 flex-col flex items-center">
            ...
            <img src="images/photo-devis-gratuit.png" className="h-60  " alt="..." />
          </div>
            ...
            <ul className="mb-0 list-none">
              {menuItems.map((menuItem, index) => (
                <li key={index}>
                  <a
                    href={menuItem.route}
                    className=" text-white hover:text-sky-200 dark:text-neutral-200"
                  >
                    {menuItem.label}
                  </a>
                </li>
